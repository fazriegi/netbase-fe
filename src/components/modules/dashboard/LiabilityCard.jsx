...
export default function LiabilityCard({ data, loading }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: isMobile ? 4 : 8, zIndex: 2 }}>
        <Tooltip
          title={isMasked ? "Click eye icon to reveal" : formatRupiah(totalLiabilities, false)}
          placement="topLeft"
        >
          <div
            style={{
          ...
          >
            {formatRupiah(totalLiabilities, isMasked)}
          </div>
        </Tooltip>
      </div>

      {/* Bottom Glowing Coral/Red Bar */}
      <div
        style={{
          position: "absolute",
          bottom: 0,
          ...
          boxShadow: "0 0 12px rgba(239, 68, 68, 0.8), 0 -1px 8px rgba(244, 63, 94, 0.5)",
        }}
      />
    </Card>
  );
